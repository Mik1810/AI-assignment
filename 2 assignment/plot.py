...
class Plot:
    ...
    def draw_grid(self):
        ...
        self.ax.annotate("s", (label_s_x - 1, label_s_y - 1), color='black', weight='bold', fontsize=10, ha='center',
                         va='center')
        self.ax.annotate("g", (label_g_x - 1, label_g_y - 1), color='black', weight='bold', fontsize=10, ha='center',
                         va='center')
