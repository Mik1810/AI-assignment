...
def ac_search_solver(csp):
    """arc consistency (constraint interface)"""
...
#searcher1d = Searcher(Search_with_AC_from_CSP(crossword1))

#Searcher.max_display_level = 2  # display constraint trace (0 turns off)
#searcher2c = Searcher(Search_with_AC_from_CSP(csp2))
#print(searcher2c.constraint())
#searcher3c = Searcher(Search_with_AC_from_CSP(crossword1))
#print(searcher3c.constraint())
#searcher4c = Searcher(Search_with_AC_from_CSP(crossword1d))
#print(searcher4c.constraint())
