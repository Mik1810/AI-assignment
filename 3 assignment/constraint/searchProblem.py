# searchProblem.py - representations of constraint problems
...
class Search_problem(object):
    ...
    * a (optional) heuristic function.
    The methods must be overridden to define a constraint problem."""
...
class Search_problem_from_explicit_graph(Search_problem):
    ...
    * a dictionary that maps each node into its (x,y) position
    ...
    def __repr__(self):
        """returns a string representation of the constraint problem"""
        res=""
