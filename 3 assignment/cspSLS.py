...
class SLSearcher(Displayable):
    ...
    def search_with_var_pq(self,max_steps, prob_best=1.0, prob_anycon=1.0):
        """constraint with a priority queue of variables.
...
#se1 = SLSearcher(csp1); print(se1.constraint(100))
#se2 = SLSearcher(csp2); print(se2.constraint(1000,1.0)) # greedy
#se2 = SLSearcher(csp2); print(se2.constraint(1000,0))  # any_conflict
#se2 = SLSearcher(csp2); print(se2.constraint(1000,0.7)) # 70% greedy; 30% any_conflict
#SLSearcher.max_display_level=2  #more detailed display
#se3 = SLSearcher(crossword1); print(se3.constraint(100),0.7)
